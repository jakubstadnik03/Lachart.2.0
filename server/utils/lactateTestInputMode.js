 ...
 *
 * CommonJS twin of client/src/utils/lactateTestInputMode.js, produced by
 ...
 */
function normalizeLactateSport(sport) {
 ...
 */
function getEffectiveLactateInputMode(mockData) {
 ...
 */
function getLactateDisplayMode(mockData, user) {
...
module.exports = {
  getEffectiveLactateInputMode,
  getLactateDisplayMode,
  normalizeLactateSport,
};
