/* GENERATED from client/src/utils/lactateThresholdEngine.js by scripts/syncLactateEngine.js — do not edit here. */
'use strict';
...
const LT1_RISE_MMOL = 0.8;
const LT1_TARGET_MIN_MMOL = 1.5;
const LT1_MIN_ABOVE_BASE = 0.4;
/** LT1 lactate ceiling: 2.5 mmol/L, up to 3.0 for an athlete whose floor is high. */
const LT1_CAP_MIN_MMOL = 2.5;
const LT1_CAP_MAX_MMOL = 3.0;
/** How much of LT1 is the baseline crossing; the rest is where the curve bends. */
const LT1_CROSSING_WEIGHT = 0.7;
const LT2_MIN_MMOL = 2.5;
const LT2_MAX_MMOL = 5.5;
const OBLA_MMOL = 4.0;
const OBLA_FALLBACK_MMOL = 3.5;
const IAT_RISE_MMOL = 1.5;
const MIN_LT2_OVER_LT1 = 1.04;
...
function toIntensity(power, sport) {
...
function fromIntensity(u, sport) {
...
function firstCrossing(f, x0, x1, target) {
 ...
 */
function logLogBreakpoint(u, la) {
  const pts = [];
 ...
 */
function segmentedBreakpoints(u, la) {
  const n = u.length;
...
function dropOutOfOrderStages(stages) {
 ...
 */
function analyzeLactateTest({ sport = 'bike', stages = [], baseLactate = null } = {}) {
  const notes = [];
  const raw = (stages || [])
    .map((s) => ({
...
module.exports = { LT1_RISE_MMOL, LT1_TARGET_MIN_MMOL, LT1_MIN_ABOVE_BASE, LT1_CAP_MIN_MMOL, LT1_CAP_MAX_MMOL, LT1_CROSSING_WEIGHT, LT2_MIN_MMOL, LT2_MAX_MMOL, OBLA_MMOL, OBLA_FALLBACK_MMOL, IAT_RISE_MMOL, MIN_LT2_OVER_LT1, isPaceSport, toIntensity, fromIntensity, isotonic, monotoneCubic, interpolateAt, firstCrossing, dmaxOnCurve, logLogBreakpoint, segmentedBreakpoints, dropOutOfOrderStages, analyzeLactateTest };
