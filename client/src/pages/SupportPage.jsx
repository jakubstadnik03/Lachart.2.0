    ...
    ...(onNativeIos ? [] : [{
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Yes — every paid plan includes a 14-day (2 weeks) free trial. You won't be charged until the trial ends, and you can cancel anytime before that at no cost. After the trial, billing starts automatically. You can manage your subscription in Settings → Subscription.",
        },
        {
