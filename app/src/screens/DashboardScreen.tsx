...
import { DailyCoachCard } from '../coach/DailyCoachCard';
...
export function DashboardScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 16, gap: 12 }}>
      ...
      {/* The day's coaching, above everything else — it answers what the athlete
          opened the app to find out. Renders nothing if the card can't be built. */}
      <DailyCoachCard />
